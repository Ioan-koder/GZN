#Добавление участка: Выберите опцию 1, введите кадастровый номер, площадь, категорию земли (например, "сельхозназначения") и разрешенное использование (например, "выращивание зерновых").
#Обновление фактического использования: Выберите опцию 2, введите кадастровый номер и фактическое использование (например, "строительство"). Программа автоматически проверит, соответствует ли использование разрешенному, и зафиксирует нарушение, если оно есть.
#Генерация отчета: Выберите опцию 3, чтобы создать текстовый файл land_report.txt с информацией об участках и выявленных нарушениях.
#Выход: Выберите опцию 4 для завершения работы.
